...
# This script imports the files from the filepaths generated by the find_fbx.py. after import it generates a lightmap uv and then exports it to the same location
